...
const bookingAirports = [
  ...
  { icao: 'EFHK', short: 'HEL', name: 'Helsinki-Vantaa', city: 'Helsinki-Vantaa', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 60.3172, lon: 24.9633 },
  { icao: 'EFHA', short: 'KEV', name: 'Halli', city: 'Halli', country: 'Finland', type: 'GA / military', network: 'Finavia', lat: 61.8560, lon: 24.7867 },
  { icao: 'EFIV', short: 'IVL', name: 'Ivalo', city: 'Ivalo', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 68.6073, lon: 27.4053 },
  { icao: 'EFJO', short: 'JOE', name: 'Joensuu', city: 'Joensuu', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 62.6629, lon: 29.6075 },
  { icao: 'EFJY', short: 'JYV', name: 'Jyväskylä', city: 'Jyväskylä', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 62.3995, lon: 25.6783 },
  { icao: 'EFKI', short: 'KAJ', name: 'Kajaani', city: 'Kajaani', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 64.2855, lon: 27.6924 },
  { icao: 'EFKE', short: 'KEM', name: 'Kemi-Tornio', city: 'Kemi-Tornio', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 65.7787, lon: 24.5821 },
  { icao: 'EFKT', short: 'KTT', name: 'Kittilä', city: 'Kittilä', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 67.7010, lon: 24.8468 },
  { icao: 'EFKK', short: 'KOK', name: 'Kokkola-Pietarsaari', city: 'Kokkola-Pietarsaari', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 63.7212, lon: 23.1431 },
  { icao: 'EFKU', short: 'KUO', name: 'Kuopio', city: 'Kuopio', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 63.0071, lon: 27.7978 },
  { icao: 'EFKS', short: 'KAO', name: 'Kuusamo', city: 'Kuusamo', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 65.9876, lon: 29.2394 },
  { icao: 'EFMA', short: 'MHQ', name: 'Mariehamn', city: 'Mariehamn', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 60.1222, lon: 19.8982 },
  { icao: 'EFOU', short: 'OUL', name: 'Oulu', city: 'Oulu', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 64.9301, lon: 25.3546 },
  { icao: 'EFPO', short: 'POR', name: 'Pori', city: 'Pori', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 61.4617, lon: 21.7999 },
  { icao: 'EFRO', short: 'RVN', name: 'Rovaniemi', city: 'Rovaniemi', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 66.5648, lon: 25.8304 },
  { icao: 'EFSA', short: 'SVL', name: 'Savonlinna', city: 'Savonlinna', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 61.9431, lon: 28.9451 },
  { icao: 'EFTP', short: 'TMP', name: 'Tampere-Pirkkala', city: 'Tampere-Pirkkala', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 61.4141, lon: 23.6044 },
  { icao: 'EFTU', short: 'TKU', name: 'Turku', city: 'Turku', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 60.5141, lon: 22.2628 },
  { icao: 'EFUT', short: 'UTI', name: 'Utti', city: 'Utti', country: 'Finland', type: 'GA / military', network: 'Finavia', lat: 60.8964, lon: 26.9384 },
  { icao: 'EFVA', short: 'VAA', name: 'Vaasa', city: 'Vaasa', country: 'Finland', type: 'controlled', network: 'Finavia', lat: 63.0507, lon: 21.7622 },
